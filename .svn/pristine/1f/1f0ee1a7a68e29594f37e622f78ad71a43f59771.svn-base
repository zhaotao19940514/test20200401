...
<div class="modal-header">
	...
	<h4 class="modal-title">模板管理--添加</h4>
</div>
<div class="modal-body">
	<form:form modelAttribute="pageModel" id="myForm" name="myForm" cssClass="form-horizontal" action="${rootUrl }app/template/add" method="post">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
		    <select name="projectId" class="taiji_autocomplete form-control" data-url="${rootUrl }app/template/listByProjectName" data-placeholder="请选择项目" style="width: 150px">
					<option></option>
			</select>
	    </div>
	  </div>
