				...
				<div class="col-md-12">
					...
					<div id="myManage" class="panel panel-inverse">
						<div class="panel-heading">
							...
							<h4 class="panel-title">黔通卡库存管理</h4>
						</div>
						<div class="panel-toolbar ">
							<a
								href="${rootUrl }app/administration/inventory/devicewarehousing/card/add"
								class="taiji_modal	taiji_acl btn  btn-success m-5"><i
								class="fa fa-plus m-r-5"></i>入库添加</a>
								<a
								href="${rootUrl }app/administration/inventory/deviceallocation/card/add"
								class="taiji_modal	taiji_acl btn  btn-success m-5"><i
						...
						<div class="panel-body">
							<form:form modelAttribute="queryModel"
								...
								name="listForm"
								action="${rootUrl}app/administration/inventory/devicewarehousing/card/manage"
								method="post">
								<div class="form-group">
									...
									<div class="form-group m-5">
										...
										<form:input path="cardId" size="20" maxlength="50"
