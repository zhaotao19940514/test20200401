 ...
 <script type="text/javascript">
		$(function(){
			...
			$("#readOldCard").click(function(){
				...
				$("#oldPreBalance").val(preBalance/100);
			});
			$("#readNewCard").click(function(){
				...
				var preBalance =cardReader.getBalance();
				$("#newPreBalance").val(preBalance/100);
			});
                        ...
                        <div class="panel-body">
                        	<form:form modelAttribute="queryModel" cssClass="taiji_search_form form-inline m-t-5 " id="listForm" name="listForm" action="${rootUrl}app/customerservice/finance/balancesupply/manage" method="post">
								...
								<div class="form-group" style="display: none" >
									<input id="cardStatus" type="text" readonly="readonly"  value="判断是否为读卡得到的旧卡信息"  >
								</div>
								<br>
								<div class="form-group" >
									<form:label  path="oldPreBalance">旧卡可补领金额(元)</form:label>
									<input id="oldPreBalance"  readonly="readonly"   />
								</div>
