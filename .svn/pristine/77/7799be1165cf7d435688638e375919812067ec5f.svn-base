			    ...
			    <div class="col-md-12">
                    ...
                    <div id="myManage" class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">设备发行</h4>
                        </div>
                        <div class="panel-body">
                        	<form:form modelAttribute="queryModel" cssClass="taiji_search_form form-inline m-t-5 " id="listForm" name="listForm" action="${rootUrl}app/apply/quickapply/equipmentissue/manage" method="post">
                        		<div class="form-group">
									...
									<div class="form-group m-5">
										<form:label path="ownerIdType">车辆所有人证件类型</form:label>
									...
									<div class="form-group m-5">
										<form:label path="ownerIdNum">车辆所有人证件号</form:label>
										<form:input path="ownerIdNum"  maxlength="100"  cssClass="form-control"  placeholder="车辆所有人证件号" />								    								       										
									</div>
									<div class="form-group m-5">
										<form:label path="ownerName">车辆所有人名称</form:label>
										<form:input path="ownerName"  maxlength="100"  cssClass="form-control"  placeholder="车辆所有人名称" />
									</div>
									<div class="form-group m-5">
