			    ...
			    <div class="col-md-12">
                    ...
                    <div id="myManage" class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">OBU查询</h4>
                        </div>
                        <div class="panel-body">
                        	<form:form modelAttribute="queryModel" cssClass="taiji_search_form form-inline m-t-5 " id="listForm" name="listForm" action="${rootUrl}app/apply/baseinfo/obu/manage" method="post">
								<div class="form-group">
									...
									<div class="form-group m-5">
										...
										<form:input path="obuId" id="obuId"  maxlength="100"  cssClass="form-control"  placeholder="OBU编号" />	
										<button class="btn btn-default btn-success" type="button" id="readObuBtn"><i class="fa fa-credit-card m-r-10 "></i>读OBU</button>
									</div>
									<div class="form-group m-5">
										...
										<form:select path="status"  cssClass="form-control m-r-5" data-style="btn-white" data-width="100px">
											<form:option value="">--请选择--</form:option>
											<form:options items="${obuUploadStatus}" itemLabel="value" itemValue="code"/>
										</form:select>
									</div>
									<div class="form-group m-5">
