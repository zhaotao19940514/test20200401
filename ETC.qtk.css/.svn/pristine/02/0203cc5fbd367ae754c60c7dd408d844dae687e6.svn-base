...
// 		}
		$("#addFormDiv").taiji("ajaxForm",$("#addForm"),{
			bsSuccess:function(responseText,note){
				...
				$("#carContent").show();
				$("#addCustomer").hide();
				var addCar = '<a href="${rootUrl }app/apply/baseinfo/usermanager/addCar/' + cstmId +'" class="taiji_modal_lg taiji_acl btn  btn-success m-5"><i class="fa fa-plus m-r-5"></i>新增车辆</a>';
				$("#addCar").prepend(addCar);
				$("#searchCardBtn").click();
				var viewPic = '<a href="${rootUrl }app/apply/quickapply/quickopen/view/' + cstmId +'" class="taiji_modal_lg taiji_acl btn  btn-success m-5">查看开户证件图片</a>';
						...
						<div class="panel-body">
							<div id='addFormDiv'>
								<form:form modelAttribute="pageModel"
									...
									action="${rootUrl}app/apply/quickapply/quickopen/add"
									method="post">
							...
							<div id="carContent" style="display: none;">
								<div class="panel-body">
									<form:form cssClass="taiji_search_form form-inline m-t-5 "
										...
										action="${rootUrl}app/apply/quickapply/quickopen/manage" method="post">
