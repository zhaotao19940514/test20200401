			...
			<div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <div id="myManage" class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">4x卡号段管理</h4>
                        </div>
                        <div class="panel-body">
                        	<form:form cssClass="taiji_search_form form-inline m-t-5 " modelAttribute="queryModel"  id="listForm" name="listForm" action="${rootUrl}app/administration/section4x/card/manage" method="post">
                        	<div class="form-group">
									<div class="form-group m-5">
										<form:label path="cardId">卡号</form:label>
										<form:input path="cardId" cssClass="form-control" placeholder=""/>
				...
				<label class="control-label">每页条数</label>	
						<form:select path="pageSize"  cssClass="form-control">
							...
							<a href="${rootUrl }app/administration/section4x/card/add"  class="taiji_modal_lg taiji_acl btn  btn-success m-5"><i class="fa fa-plus m-r-5"></i>添加号段</a>
							<a href="${rootUrl }app/administration/section4x/card/batchAdd"  class="taiji_modal_lg taiji_acl btn  btn-success m-5"><i class="fa fa-plus m-r-5"></i>批量添加号段</a>
