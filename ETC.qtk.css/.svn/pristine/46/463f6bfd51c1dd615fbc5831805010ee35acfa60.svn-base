...
<div class="modal-header">
	...
	<h4 class="modal-title">4x版本OBU号段管理--添加</h4>
</div>
<div class="modal-body">
	<form:form modelAttribute="addModel" id="myForm" name="myForm" cssClass="form-horizontal" action="${rootUrl }app/administration/section4x/obu/add" method="POST">
									...
									<button type="button" onclick="minus()">计算OBU数量</button>
								<span id="amount"> 共计 个</span>	
										</div>
