...
<div class="modal-header">
	...
	<h4 class="modal-title">渠道权限管理--批量添加</h4>
</div>
<div class="modal-body">
	<form:form modelAttribute="batchAddModel" id="myForm" name="myForm" cssClass="form-horizontal" action="${rootUrl }app/administration/agencypermission/batchAdd" method="POST">
				...
				<div>
					<div style="width:230px;height:60px;">
						...
						<div style="width:100px;height:60px;">
							<span style="font-size: 15px">批量添加类型</span>
							<select name="batchType" id="batchType" class="taiji form-control" style="width:240px;">
							<option value="">---------请选择批量添加类型----------------</option>
							<option value="0">根据控制渠道批量添加</option>
							<option value="1">根据被控制渠道批量添加</option>
							</select>
						</div>
