var MisPosClient = function() {
	// chrome
	this.objStr = '<object id="ICBCMisPosClient" type="application/x-itst-activex" width="0" height="0" clsid="{7e50e44e-a583-4ff1-80de-f69438b22b63}" progid="${rootUrl}posOcx/CardMis.ocx#version=1,0,0,2"></object>';
	// ie
//	this.objStr = '<object id="ICBCMisPosClient"  classid="clsid:{7e50e44e-a583-4ff1-80de-f69438b22b63}" codebase="${rootUrl}posOcx/CardMis.ocx#version=1,0,0,1" style="display:none;"></object>';
