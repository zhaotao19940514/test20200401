			    ...
			    <div class="col-md-12">
                    ...
                    <div id="myManage" class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">网点充值统计</h4>
                        </div>                       
                        <div class="panel-body">
                        	<form:form cssClass="taiji_search_form form-inline m-t-5 " modelAttribute="queryModel"  id="listForm" name="listForm" action="${rootUrl}app/administration/channelacountchargecount/manage" method="post">
                      			<br>
                      			<%-- <div class="form-group m-t-2"> 
									<label class="control-label">查询日期</label>
									<form:input path="handleDate" placeholder="格式:2018-12-12 "  cssClass="form-control"/>	
								</div> --%>																														
						...
						<div  class="input-group">
						    ...
						    <span class="input-group-btn">
								<button type="button" class="btn btn-default" onclick="WdatePicker({el:$dp.$('startDate'),dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'endDate\')}'});"><i class="fa fa-calendar"></i></button>
							</span>
						</div>
					</div>
					<div class="form-group m-t-5">	
						...
						<div  class="input-group">
							...
							<span class="input-group-btn">
								<button type="button" class="btn btn-default"  onclick="WdatePicker({el:$dp.$('endDate'),dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'startDate\')}'});"><i class="fa fa-calendar"></i></button>
							</span>
						</div>
	 				</div>
