...
public class ForcefixRequest extends JpaDateTimePageableDataRequest<ChargeDetail> {
	...
	public void validate() {
		...
		if(cardId == null) mve.addViolation("cardId", "卡号 不能为空！");
	...
	public HqlBuilder toSelectHql() {
		...
		HqlBuilder hql = new HqlBuilder("from " + "ChargeDetail " +
				"  where 1=1 ");
		hql.append(" and status =8  or status=0");
