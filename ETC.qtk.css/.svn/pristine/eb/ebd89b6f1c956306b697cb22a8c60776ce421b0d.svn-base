			    ...
			    <div class="col-md-12">
                    ...
                    <div id="myManage" class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	<form:form cssClass="taiji_search_form form-inline m-t-5 " modelAttribute="queryModel"  id="listForm" name="listForm" action="${rootUrl}app/customerservice/report/channelIdcount/manage" method="post">
                      			 <div class="form-group m-t-5">
										<label class="control-label">地区：</label> <select
											id="regionId" name="regionId" class="form-control  m-r-5"
