...
// 				}
			...
			$("#vehicleCheckBtn").click(function() {
				...
				if(vehiclePlate == null || vehiclePlate == ""){
					...
					$.ajax({
						url:url+"app/apply/baseinfo/vehiclemanagement/vehicleCheck",
						data:{
...
<form:form modelAttribute="pageModel" id="myForm" name="myForm" cssClass="form-horizontal" action="${rootUrl }app/apply/baseinfo/usermanager/addCar" method="post">
			...
			<table border="1">
				...
				<tr>
					...
					<td class="titile">使用性质：</td><td class="details">
										<form:select path="useCharacter"  cssClass="selectpicker form-control m-r-5" data-style="btn-white" data-width="120px">
											<form:option value="">--请选择--</form:option>
