 ...
 */
public class ReplaceRequest extends JpaDateTimePageableDataRequest<CardInfo> {
	...
	public void setRowCardId(String rowCardId) {
		this.rowCardId = rowCardId;
	}
