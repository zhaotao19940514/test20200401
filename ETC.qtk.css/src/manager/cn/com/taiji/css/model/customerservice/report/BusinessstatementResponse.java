...
public class BusinessstatementResponse extends BaseModel  {
	
	private List<Businessstatement> lists;
	 ...
	 * @return lists
	 */
	public List<Businessstatement> getLists() {
		return lists;
	}
	 ...
	 */
	public void setLists(List<Businessstatement> lists) {
		this.lists = lists;
	}
