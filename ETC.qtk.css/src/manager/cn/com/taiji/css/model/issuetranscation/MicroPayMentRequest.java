...
public class MicroPayMentRequest extends JpaPageableDataRequest<MicroPayMentDetail>{
	    private String cardId;
	    private String vehiclePlate;
	    private String enTime;
	    private String exTime;	    
	    public MicroPayMentRequest() {
	    	
	    }

	@Override
	public HqlBuilder toSelectHql() {
		HqlBuilder hql = new HqlBuilder("from " + "MicroPayMentDetail " +
				"  where 1=1 ");
