...
@Controller
@RequestMapping("/customerservice/report/businessstatement")
public class BusinessstatementController extends MyLogController{
	private final String prefix = "customerservice/report/businessstatement/";
