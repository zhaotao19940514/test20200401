...
@Controller
@RequestMapping("/customerservice/report/channelIdcount")
public class ChannelIdCountController extends MyLogController{
	private final String prefix = "customerservice/report/channelIdcount/";
	...
	{  
		model.addAttribute("pagn", financialstatementManager.findByRegionId(queryModel));
		model.addAttribute("Region", Region.values());
