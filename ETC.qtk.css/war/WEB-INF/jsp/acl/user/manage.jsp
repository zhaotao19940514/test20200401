			    ...
			    <div class="col-md-12">
                    ...
                    <div id="myManage" class="panel panel-inverse">
                        ...
                        <div class="panel-toolbar ">
                     		...
                     		<a href="${rootUrl }app/acl/user/file"  class="taiji_modal	 taiji_acl btn  btn-success m-5"><i class="fa fa-upload" > </i>导入Excel</a>
                        </div>
                         <div class="panel-toolbar ">
                     		<button id="docDownload" type="button" class="btn btn-primary btn-sm"><i class="fa fa-download"> </i>下载导入用户模板</button>
			                       <form action="${rootUrl}app/user/dlocx/userExcel" method="post" class="hide">
                        ...
                        <div class="panel-body">
                        	<form:form cssClass="taiji_search_form form-inline m-t-5 " modelAttribute="queryModel"  id="listForm" name="listForm" action="${rootUrl}app/acl/user/manage" method="post">
								...
								<div class="form-group m-5">
									<form:input path="staffId" size="25" maxlength="50" placeholder="工号"  cssClass="form-control"/>
								</div>
								<div class="form-group m-5">
