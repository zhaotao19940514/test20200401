				...
				<div class="col-md-12">
					<div id="myManage" class="panel panel-inverse">
						<div class="panel-heading">
							...
							<h4 class="panel-title">机构管理</h4>
						</div>

						<div class="panel-body">
							<form:form cssClass="taiji_search_form form-inline m-t-5"
								modelAttribute="queryModel" id="listForm" name="listForm"
								action="${rootUrl}app/administration/agency/manage" method="post">
								<a href="${rootUrl}app/administration/agency/add"  class="taiji_modal_lg taiji_acl btn btn-success m-r-10"><i class="fa fa-plus m-r-5"></i>添加</a>
								<!-- 查询条件 -->
								...
								<div class="form-group m-t-5">
									<label class="control-label">发行方编号</label>
									<form:input path="queryIssuerId" cssClass="form-control"
										maxlength="20" size="20" />
								</div>
                                <div class="form-group m-t-5">
                                    <label class="control-label">机构联系人姓名</label>
                                    <form:input path="queryContact" cssClass="form-control"
                                        maxlength="20" size="20" />
                                </div>
                                <div class="form-group m-t-5">
                                    <label class="control-label">机构联系人电话</label>
                                    <form:input path="queryTel" cssClass="form-control"
                                        maxlength="20" size="20" />
                                </div>
