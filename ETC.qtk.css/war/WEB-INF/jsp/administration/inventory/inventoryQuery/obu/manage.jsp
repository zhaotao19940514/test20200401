				...
				<div class="col-md-12">
					...
					<div id="myManage" class="panel panel-inverse">
						<div class="panel-heading">
							...
							<h4 class="panel-title">OBU库存查询</h4>
						</div>
						<div class="panel-body">
							<form:form modelAttribute="queryModel"
								cssClass="taiji_search_form form-inline m-t-5 " id="listForm"
								name="listForm"
								action="${rootUrl}app/administration/inventory/inventoryQuery/obu/manage"
								method="post">
								<div class="form-group">
									...
									<div class="form-group m-5">
										<form:label path="startObuId">obu号</form:label>
										<form:input path="startObuId" size="25" maxlength="50"
											placeholder="obu号" cssClass="form-control" />
										<form:label path="endObuId">至</form:label>
										<form:input path="endObuId" size="25" maxlength="50"
											placeholder="obu号" cssClass="form-control" />
									</div>
									<div class="form-group m-5">
