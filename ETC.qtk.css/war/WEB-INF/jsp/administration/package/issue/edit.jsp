...
<body>
	<div class="modal-header">
		...
		<h4 class="modal-title">发行套餐管理--修改</h4>
	</div>
	<div class="modal-body">
		<form:form modelAttribute="pageModel" id="myForm" name="myForm"
			cssClass="form-horizontal" action="${rootUrl }app/administration/package/issue/edit"
			method="post">
			<form:hidden path="id" />
			<table class="table table-bordered table-striped">
				<tr>
					<td><label for='packageName' class="control-label">套餐名称</label>
					</td>
					<td><form:input path="packageName" cssClass="form-control"
							required="required" maxlength="20" placeholder="套餐名称必填" /></td>
				</tr>
				<tr>
					<td><label for='packageNum' class="control-label">套餐编号</label>
					</td>
					<td><form:input path="packageNum" cssClass="form-control"
							required="required" placeholder="套餐编号必填"  maxlength="3" htmlEscape="false" onkeyup="validPackageNum(this)"/></td>
				</tr>
				
				<tr>
					<td><label for='vehicleType' class="control-label">客货类别</label>
					</td>
					<td><form:select path="vehicleType" class="form-control m-r-5"
							title="请选择客货类别" data-style="btn-white">
				...
				<tr>
					<td><label class="control-label" for='enableTime'>生效日期</label>
					</td>
					<td>
				...
				<tr>
					<td><label class="control-label" for="expireTime">失效日期</label>
					</td>
					<td>
						<div class="form-inline">
				...
				<tr>
					<td><span class="form-inline"> <label
							class="control-label" for='rechargeMoney'>充值金额</label>
					</span></td>
					<td><span class="form-inline"> <form:input
								path="rechargeMoney" cssClass="form-control"
								style="width:150px;" required="required" onkeyup="clearNoNum(this)" htmlEscape="false" placeholder="充值金额必填" />
					</span> <span style="margin-left: 2em;"> <label
							class="control-label" for="rechargeType">是否刷POS</label> <!-- 						    <div data-for="rechargeType">  -->
				...
				<tr>
					<td><span class="form-inline"> <label
							class="control-label" for='obuCost'>OBU费用</label>
					</span>
					<td><span class="form-inline"> <form:input
								path="obuCost" cssClass="form-control" style="width:150px;"
								required="required" placeholder="OBU费用必填" htmlEscape="false" onkeyup="clearNoNum(this)"/>
					</span> <span style="margin-left: 2em;"> <label
							class="control-label" for="obuCostType">是否刷POS</label>
							<form:radiobutton path="obuCostType" value="0" /><label>是</label> <form:radiobutton
								path="obuCostType" value="1" /><label>否</label>
					</span></td>
				</tr>
				<tr>
					<td><span class="form-inline"> <label
							class="control-label" for='cardCost'>卡费用</label>
					</span>
					<td><span class="form-inline"> <form:input
								path="cardCost" cssClass="form-control" style="width:150px;"
								required="required" placeholder="卡费用必填" htmlEscape="false" onkeyup="clearNoNum(this)" />
					</span> <span style="margin-left: 2em;"> <label
							class="control-label" for="cardCostType">是否刷POS</label> 
							<form:radiobutton path="cardCostType" value="0" /><label>是</label> <form:radiobutton
								path="cardCostType" value="1" /><label>否</label>
					</span></td>
				</tr>
			</table>
