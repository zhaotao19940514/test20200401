...
<tr>
	...
	<td>
		<c:choose>
			<c:when test="${vo.status eq '1'||vo.status eq '6'}">
				<a param = "${vo.cardId}" href="javascript:void(0)" id="hangBtn" class="taiji_acl m-r-10" >挂起</a>
			</c:when>
			<c:otherwise>
				<a  href="javascript:void(0);" id="hangBtnOff" class="taiji_acl" style="opacity: 0.2">挂起</a>
			</c:otherwise>
