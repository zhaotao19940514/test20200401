...
$(function(){
	...
	$("#my-table").on('click','#unhangBtnOff',function(){
		$.Taiji.showWarn("卡状态为挂起才能解除挂起");
	});
	$("#my-table").on('click','#unhangBtn',function(){
		var cardId = $(this).attr("param");
		$.Taiji.defConfirm("你确定要对该卡进行解除挂起？").done(function(){
			dounHang(cardId);	
		});
	});
...
function dounHang(cardId){
	$.Taiji.showLoading($.Taiji.Messages.MSG_OPERATE);
	  var data = {};
	  data.cardId = cardId;
	  $.ajax({
          url : rootUrl+"app/customerservice/card/unhang/unHangCard",
          type : "POST",
          dataType : "json",
			    ...
			    <div class="col-md-12">
                    ...
                    <div id="myManage" class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">卡片解除挂起</h4>
                        </div>
                        <div class="panel-body">
                        	<form:form modelAttribute="queryModel" cssClass="taiji_search_form form-inline m-t-5 " id="listForm" name="listForm" action="${rootUrl }app/customerservice/card/unhang/manage" method="POST">
