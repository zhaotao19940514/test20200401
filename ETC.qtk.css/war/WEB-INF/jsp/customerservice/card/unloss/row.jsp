...
<tr>
	...
	<td>
		...
		<c:choose>
			<c:when test="${vo.status ne '6'}">
				<a href="javascript:void(0);" id="unLossBtnOff" class="taiji_acl" style="opacity: 0.2">解挂</a>
			</c:when>
			<c:otherwise>
				<!-- <a href="${rootUrl }app/customerservice/card/unloss/unlossCard/${vo.cardId}" class="taiji_update {confirm_message:'你确定要解挂此卡？ '} taiji_acl m-r-10">解挂</a> -->
				<a param = '${vo.cardId }' href="#" id="unLossBtn" class="taiji_acl m-r-10">解挂</a>
			</c:otherwise>
		</c:choose>
	</td>
</tr>
