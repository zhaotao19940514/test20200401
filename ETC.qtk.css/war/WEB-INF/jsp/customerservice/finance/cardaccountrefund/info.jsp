...
<html>
	<head>
		...
		function subRefundInfo(){
			...
			$.ajax({
			      url : rootUrl+"app/customerservice/finance/cardaccountrefund/saveRefundInfo",
			      type : "POST",
			      dataType : "json",
...
<form:form modelAttribute="pageModel2" id="myForm" name="myForm" cssClass="form-horizontal">
	<table class="table table-bordered table-striped">
		<tr>
			...
			<td>
				<input style="width:280px;color:red;font-size:20px; font-weight:bold;" value="${balance/100}元"  class="form-control" disabled="true" />
			</td>
		</tr>
		<c:choose>
			...
			<c:otherwise>
				<tr>
					...
					<td>
						<input  class="form-control" required="required" onblur="onblurText();" onfocus = "onfocusText();" value="${balance/100}" id="refundBalance" placeholder="请输入退款金额" />
					</td>
				</tr>
			</c:otherwise>
		</c:choose>
