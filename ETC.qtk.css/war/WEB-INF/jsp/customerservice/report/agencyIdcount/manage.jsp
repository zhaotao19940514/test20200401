			    ...
			    <div class="col-md-12">
                    ...
                    <div id="myManage" class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">合作机构统计</h4>
                        </div>                       
                        <div class="panel-body">
                        	<form:form cssClass="taiji_search_form form-inline m-t-5 " modelAttribute="queryModel"  id="listForm" name="listForm" action="${rootUrl}app/customerservice/report/agencyIdcount/manage" method="post">
                      			 <%-- <div class="form-group m-t-5">
										<label class="control-label">合作机构：</label> <select
											id="agencyIds" name="agencyIds" class="form-control  m-r-5"
											data-style="btn-white" data-width="100px">
											<c:forEach items="${AgencyName}" var="an">
