			    ...
			    <div class="col-md-12">
                    ...
                    <div id="myManage" class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">地区预付费统计</h4>
                        </div>
...
<div class="form-group m-5">
			...
			<div class="form-group m-5">
						...
						<label class="control-label">网点区域</label>
						<input type="text" value="贵州区域">
						<label class="control-label">营业厅</label>
						<input type="text" value="全部营业厅">
