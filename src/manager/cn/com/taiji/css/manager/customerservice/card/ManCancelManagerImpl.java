...
public class ManCancelManagerImpl extends AbstractDsiCommManager implements ManCancelManager{
	...
	@Override
	public boolean cancel15ArgueTime(String cardId) throws ManagerException {
		...
		LocalDate cancelDate = LocalDate.parse(format.format(detail.getCreateTime().getTime())).plusDays(15); 
