...
@Controller
@RequestMapping("/apply/baseinfo/usermanager")
public class CustomerManagerController extends MyLogController {
	...
	private final String prefix = "/apply/baseinfo/usermanager/";
...
//			req.setAgencyId(LoginHelper.getLoginUser(request).getStaff().getServiceHall().getAgencyId());
				...
				HttpServletResponse response) throws ManagerException
		{
			...
			model.addAttribute("carType", CarType.values());
			super.doAddLog(request, CssServiceLogType.APPLY_BASEINFO_VEHICLE, vhcl);
		...
		public void processEdit(@Valid @ModelAttribute("pageModel") QuickApplyPngModel customerInfo, HttpServletRequest request,
			...
			super.doUpdateLog(request, CssServiceLogType.APPLY_BASEINFO_CUSTOMER, cstm);
