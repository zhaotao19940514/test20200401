			    ...
			    <div class="col-md-12">
                    ...
                    <div id="myManage" class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">obu黑名单增量查询（最迟一小时刷新）</h4>
                        </div>
                        
                        <div class="panel-body">
                        	<form:form cssClass="taiji_search_form form-inline m-t-5 " modelAttribute="queryModel"  id="listForm" name="listForm" action="${rootUrl}app/acl/obuBlackListIncr/manage" method="post">
								<div class="form-group m-5">
									<form:input path="obuId" size="50" maxlength="50" placeholder="obu号"  cssClass="form-control"/>
								</div>
<!-- 								<div class="form-group m-5"> -->
