		...
		$("#fileDiv")
				.append(
						" <div class='"+range+"id' style='margin-top:5px;'><div style='width:300px;display:inline;'>"
								...
								+ range
								+ "')  style='color:red;float:none;font-size:14px;padding:2px 10px;margin-left:20px;' class='btn btn-sm btn-white deleteName'>删除</button></div>");
		$("#" + range + "_id").click();
	}
...
<body>
	...
	<div class="modal-header">
		...
		<h4 class="modal-title">通知公告管理--添加</h4>
	</div>

	<div class="modal-body">
		<form:form modelAttribute="pageModel" id="myForm" name="myForm"
			cssClass="form-horizontal"
			action="${rootUrl }app/administration/notify/add" method="post">
			<input type="hidden" name="type" <%-- id="type" value="${fn:escapeXml(type)}" --%> />
			<table class="table table-bordered table-striped">
					<tr>
						<td><label class="control-label">业务员</label></td>
						<td><form:input path="name" class="form-control" placeholder="登录名必填" readonly="true" /></td>
					</tr>
					<tr>
				...
				<div class="col-sm-10">
					<div class="input-group" style="width: 280px">
						<form:input path="name" required="required"
							cssClass="form-control" placeholder="登录名必填" readonly="true"/>
					</div>
				</div>
			</div> 
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<form:input path="releaseDate" readonly="true"
			...
			<!-- <div class="form-group">
				...
				<div class="col-sm-10">
					<a href="javascript:;" onclick="addFile();"
						class="taiji_acl btn btn-success"><i
						class="fa fa-paperclip m-r-5"></i>添加附件</a>
					<div id="fileDiv" style="width: 90%; text-align: left;"></div>
				</div>
			</div> -->
