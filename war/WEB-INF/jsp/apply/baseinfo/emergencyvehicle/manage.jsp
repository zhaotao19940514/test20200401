			    ...
			    <div class="col-md-12">
                    ...
                    <div id="myManage" class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">应急车辆管理</h4>
                        </div>
                        <div class="panel-body">
                        	<form:form modelAttribute="queryModel" cssClass="taiji_search_form form-inline m-t-5 " id="listForm" name="listForm" action="${rootUrl}app/apply/baseinfo/emergencyvehicle/manage" method="post">
								<div class="form-group m-5">
									...
									<div class="form-group m-5">
									    <form:label path="emergencyFlag">是否应急</form:label>
										<form:select path="emergencyFlag"  cssClass="form-control m-r-5" data-style="btn-white" data-width="150px">
