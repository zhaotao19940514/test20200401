...
<form:form modelAttribute="pageModel" id="myForm" name="myForm" cssClass="form-horizontal" action="${rootUrl }app/apply/baseinfo/vehiclemanagement/del" method="post">
		<div class="form-group">
			...
			<table border="1">
				<tr style="display: none;">
					...
					<td><form:input cssStyle="width:180px" path="vehicleId" class="form-control"  placeholder="必填"/></td>
					<td colspan="4"><form:input cssStyle="width:180px" path="outsideDimensions" class="form-control" placeholder="必填"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="details" >
							<form:select path="refrigeratedTrucks" disabled="true" cssClass="disabledRemove disabledAdd form-control m-r-5" data-style="btn-white" data-width="120px">
								<form:option value="">--请选择--</form:option>
				...
				<tr>
					...
					<td class="titile"><span class="essentialLorry">*</span>车轴数(含悬浮轴)：</td><td class="details"><form:input id="axleCount" path="axleCount" readonly="true" cssStyle="width:180px" class="form-control typeParameter" maxlength="2" min="2" placeholder="货车必填"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="titile">行驶证照片：</td><td class="details" colspan="2"><a href="${rootUrl }app/apply/baseinfo/vehiclemanagement/viewOne/${pageModel.id }" class="taiji_modal_lg taiji_acl btn  btn-success">查看</a></td>
					<td class="titile">车辆照片：</td><td class="details" colspan="2"><a href="${rootUrl }app/apply/baseinfo/vehiclemanagement/viewTwo/${pageModel.id }" class="taiji_modal_lg taiji_acl btn  btn-success">查看</a></td>
				</tr>
			</table>
			</div>
</form:form>
