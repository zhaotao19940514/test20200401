...
<div id="myManageViewInfo" class="panel panel-inverse">
		...
		<div class="form-group">
			...
			<table border="1">
				<tr style="display: none;">
					...
					<td colspan="5"><form:input cssStyle="width:180px" path="outsideDimensions" class="form-control" placeholder="必填"/></td>
				</tr>
				<tr>
