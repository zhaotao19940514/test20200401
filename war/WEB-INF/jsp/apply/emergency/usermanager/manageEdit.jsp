						...
						<div class="panel-body">
							<div id='addFormDiv'>
								<form:form modelAttribute="pageModel"
									...
									action="${rootUrl}app/apply/emergency/usermanager/edit"
									method="post">
							...
							<div class="text-right" id="operationPanel">
								...
								<a href="${rootUrl }app/apply/emergency/usermanager/addCar/${pageModel.customerId}" class="taiji_modal_lg taiji_acl btn  btn-success m-5"><i class="fa fa-plus m-r-5"></i>新增车辆</a>
							</div>
							<div id="carContent">
								<div class="panel-body">
									<form:form cssClass="taiji_search_form form-inline m-t-5 "
										modelAttribute="queryModel" id="listForm" name="listForm"
										action="${rootUrl}app/apply/emergency/usermanager/manageEdit"
										method="post">
							...
							<div class="text-right" id="operationPanel">
								<a href="${rootUrl}app/apply/emergency/usermanager/manage?myMenuId=5e8f041dc0c34c53877060014f62840d" class="btn btn-success btn-md btn-default">返回用户管理</a>
