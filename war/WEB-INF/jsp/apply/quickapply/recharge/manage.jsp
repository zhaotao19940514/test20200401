			    ...
			    <div class="col-md-12">
                    ...
                    <div id="myManage" class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	<form:form cssClass="taiji_search_form form-inline m-t-5 " modelAttribute="queryModel"  id="listForm" name="listForm" action="${rootUrl}app/apply/quickapply/recharge/manage" method="post">
                      			<br>
								<div class="form-group m-5">
									<form:input path="customerName" size="25" maxlength="50" placeholder="账户名称"  cssClass="form-control"/>
								</div> 
								<div class="form-group m-5">
									<form:input path="customerIdNum" size="25" maxlength="50" placeholder="证件号码"  cssClass="form-control"/>
								</div> 
								<div class="form-group m-5">
									<form:label path="customerType">账户状态</form:label>
									<form:select path="customerType"  cssClass="form-control m-r-5" data-style="btn-white" data-width="180px">
										<form:option value="">全部</form:option>
										<form:options items="${customerStatus}" itemLabel="value"/>
									</form:select>
								</div>
								<div class="form-group m-5">
								...
								<button class="taiji_search_reset btn btn-md btn-success m-r-5" type="button"><i class="fa  fa-refresh  m-r-10  "></i>清空</button> 
                      			<button class="taiji_search_reset btn btn-md btn-success m-r-5" type="button"><i></i>卡片圈存</button> 
                        	</form:form>
						</div>
