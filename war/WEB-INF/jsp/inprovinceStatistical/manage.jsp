			    ...
			    <div class="col-md-12">
                    ...
                    <div id="myManage" class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">省内清分结算统计</h4>
                        </div>                       
                        <div class="panel-body">
                        	<form:form cssClass="taiji_search_form form-inline m-t-5 " modelAttribute="queryModel"  id="listForm" name="listForm" action="${rootUrl}app/inprovinceStatistical/manage" method="post">
                      			<br>
                      			<div class="form-group m-t-2"> 
									<label class="control-label">渠道类型</label>
									<select id="agencyType" name="agencyType" title="请选择类型" class="selectpicker">
										<option value="" selected="selected">请选择</option>
										<option  value="1">黔通储值卡</option>
						                <option  value="2">黔通记账卡</option>
										<option  value="3">建行卡</option>
									    <option  value="4">工行卡</option>
									</select>
								</div>																														
...
<!-- 							    <input type="button" onclick="JavaScript:method1('table1');" value="导出EXCEL"  class="btn  btn-success m-r-10">				
 -->								
 								<input id="Button1" type="button" class="btn  btn-success m-r-5" value="导出EXCEL" onclick="javascript:method1('table1')" />
